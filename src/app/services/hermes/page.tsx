...
const features = [
  {
    ...
    description:
      "Engage prospects across email, SMS, and chat with personalized, AI-driven messaging that converts more leads into clients.",
    icon: MessageSquare,
  },
  {
    title: "Automated Scheduling",
    description:
      "Let Hermes handle appointment scheduling, reminders, and follow-ups, freeing your team from manual coordination.",
    icon: Calendar,
  },
  {
    title: "Smart Response Optimization",
    description:
      "AI analyzes prospect responses and optimizes communication strategies for higher engagement and conversion rates.",
    icon: Zap,
  },
];
          ...
          <section className="relative overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 py-32 pb-4 sm:px-6 lg:px-8 lg:py-40">
              ...
              >
                ...
                >
                  Your tireless sales and communication specialist that handles
                  all customer interactions, from prospecting to appointment
                  scheduling.
                </motion.p>
              </motion.div>
            </div>
          ...
          <section className="relative overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8 lg:pb-32">
              <div className="mx-auto max-w-3xl text-center">
                ...
                >
                  Automate your sales and communication for higher engagement
                  and conversions.
                </motion.p>
              </div>
                ...
                <div className="relative mx-auto max-w-3xl text-center">
                  ...
                  >
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-zinc-400">
                      Book a free strategy call to discover how Hermes can help
                      you automate outreach, boost engagement, and close more
                      deals.
                    </p>
